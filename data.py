...
if __name__ == '__main__':
    ...
    print("Load and Preprocess {} dataset".format(DATA_DIR))

    raw_data = pd.read_csv(os.path.join(DATA_DIR, 'gen/ratings.csv'), header=0)
    # Uncomment if you want to keep data only with rating greater than 3.5.
